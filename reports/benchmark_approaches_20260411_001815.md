# Benchmark Approches — 20260411_001815
...
|----------|-----|--------|-----------|------------|-------------|-----------------|---------|-------|
| baseline | Baseline (actuel) | `small` | 5 | True | 26.83s | 25.73s | 1.00x | 0.21x |
| voie1 | beam_size=1 | `small` | 1 | True | 19.50s | 18.70s | 1.38x | 0.16x |
| voie2 | model base | `base` | 5 | True | 9.51s | 8.87s | 2.90x | 0.07x |
| voie3 | vad_filter=False | `small` | 5 | False | 28.45s | 27.74s | 0.93x | 0.23x |
| voie4 | base+beam1 | `base` | 1 | False | 6.85s | 6.37s | 4.04x | 0.05x |
...
**ECHEC** : 401 Client Error. (Request ID: Root=1-69d9cbe3-66391e90417bdb8d3f47be80;a8bd39e9-1478-409b-87b4-455dbd922ac5)
...
_Généré le 2026-04-11T00:19:47.406581_
