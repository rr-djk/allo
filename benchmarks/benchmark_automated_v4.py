"""benchmark_automated_v4.py — Automated transcription benchmarking tool.
...
def main():
    ...
    elif config_name == "threads1":
        results = benchmark("small", cpu_threads=1, beam_size=1, condition_on_previous_text=False)
        
    elif config_name == "threads2":
        results = benchmark("small", cpu_threads=2, beam_size=1, condition_on_previous_text=False)

    elif config_name == "threads4":
        results = benchmark("small", cpu_threads=4, beam_size=1, condition_on_previous_text=False)
        
    elif config_name == "threads6":
        results = benchmark("small", cpu_threads=6, beam_size=1, condition_on_previous_text=False)
