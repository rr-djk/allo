"""benchmark_automated_v6.py — Automated transcription benchmarking tool.
...
def main():
    ...
    elif config_name == "turbo":
        # Note: 'turbo' is the model ID in faster-whisper (large-v3-turbo)
        results = benchmark("turbo", beam_size=1, condition_on_previous_text=False)

    elif config_name == "tiny":
        # Check speed of tiny just to see the delta
        results = benchmark("tiny", beam_size=1, condition_on_previous_text=False)
